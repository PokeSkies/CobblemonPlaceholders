    ...
    override fun register(builder: Expansion.Builder) {
        builder.filter(ServerPlayerEntity::class.java)
            .audiencePlaceholder("party_evs_hp") { audience, queue, _ ->
                ...
                return@audiencePlaceholder Tag.inserting(Component.text(pokemon.evs[Stats.HP] ?: 0))
            }
    }
}