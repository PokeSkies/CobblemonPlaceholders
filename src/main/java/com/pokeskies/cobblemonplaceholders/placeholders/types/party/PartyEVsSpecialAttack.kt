...
class PartyEVsSpecialAttack : PlayerPlaceholder {
    override fun handle(player: ServerPlayer, args: List<String>): GenericResult {
        ...
        return GenericResult.valid(Component.text(pokemon.evs[Stats.SPECIAL_ATTACK] ?: 0))
    }

    override fun id(): String = "party_evs_spa"
}
