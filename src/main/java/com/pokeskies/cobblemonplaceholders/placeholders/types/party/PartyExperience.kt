    ...
    override fun register(builder: Expansion.Builder) {
        builder.filter(ServerPlayerEntity::class.java)
            .audiencePlaceholder("party_exp") { audience, queue, _ ->
                ...
                return@audiencePlaceholder Tag.inserting(Component.text(pokemon.experience))
            }
    }
}