...
class PartyHeldItem : PlayerPlaceholder {
    override fun handle(player: ServerPlayer, args: List<String>): GenericResult {
        ...
        return GenericResult.valid(Component.text(pokemon.heldItem().displayName.string))
    }

    override fun id(): String = "party_helditem"
}
