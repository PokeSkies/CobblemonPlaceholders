    ...
    override fun register(builder: Expansion.Builder) {
        builder.filter(ServerPlayerEntity::class.java)
            .audiencePlaceholder("party_ivs_hp") { audience, queue, _ ->
                ...
                return@audiencePlaceholder Tag.inserting(Component.text(pokemon.ivs[Stats.HP] ?: 0))
            }
    }
}