...
class PartyIVsSpecialAttack : PlayerPlaceholder {
    override fun handle(player: ServerPlayer, args: List<String>): GenericResult {
        ...
        return GenericResult.valid(Component.text(pokemon.ivs[Stats.SPECIAL_ATTACK] ?: 0))
    }

    override fun id(): String = "party_ivs_spa"
}
