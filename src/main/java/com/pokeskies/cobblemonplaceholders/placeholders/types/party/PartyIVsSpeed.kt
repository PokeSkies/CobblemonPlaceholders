    ...
    override fun register(builder: Expansion.Builder) {
        builder.filter(ServerPlayerEntity::class.java)
            .audiencePlaceholder("party_ivs_spe") { audience, queue, _ ->
                ...
                return@audiencePlaceholder Tag.inserting(Component.text(pokemon.ivs[Stats.SPEED] ?: 0))
            }
    }
}