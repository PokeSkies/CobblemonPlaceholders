...
class SpeciesBaseStatsAttack : CobblemonGlobalPlaceholder {
    override fun register(builder: Expansion.Builder) {
        builder.globalPlaceholder("species_basestats_atk", this)
    }
    ...
    override fun apply(queue: ArgumentQueue, ctx: Context): Tag {
        ...
        return Tag.inserting(Component.text(species.baseStats[Stats.ATTACK] ?: 0))
    }
}