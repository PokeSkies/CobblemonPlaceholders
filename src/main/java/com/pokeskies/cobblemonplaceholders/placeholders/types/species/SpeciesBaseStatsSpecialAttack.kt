...
class SpeciesBaseStatsSpecialAttack : CobblemonGlobalPlaceholder {
    override fun register(builder: Expansion.Builder) {
        builder.globalPlaceholder("species_basestats_spa", this)
    }
    ...
    override fun apply(queue: ArgumentQueue, ctx: Context): Tag {
        ...
        return Tag.inserting(Component.text(species.baseStats[Stats.SPECIAL_ATTACK] ?: 0))
    }
}