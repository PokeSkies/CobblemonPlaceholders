...
class SpeciesBaseStatsSpecialDefence : ServerPlaceholder {
    override fun handle(args: List<String>): GenericResult {
        ...
        return GenericResult.valid(Component.text(species.baseStats[Stats.SPECIAL_DEFENCE] ?: 0))
    }

    override fun id(): String = "species_basestats_spd"
}
