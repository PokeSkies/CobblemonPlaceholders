...
class SpeciesBaseStatsSpeed : ServerPlaceholder {
    override fun handle(args: List<String>): GenericResult {
        ...
        return GenericResult.valid(Component.text(species.baseStats[Stats.SPEED] ?: 0))
    }

    override fun id(): String = "species_basestats_spe"
}
