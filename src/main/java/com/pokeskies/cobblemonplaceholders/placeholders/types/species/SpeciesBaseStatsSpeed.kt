...
class SpeciesBaseStatsSpeed : CobblemonGlobalPlaceholder {
    override fun register(builder: Expansion.Builder) {
        builder.globalPlaceholder("species_basestats_spe", this)
    }
    ...
    override fun apply(queue: ArgumentQueue, ctx: Context): Tag {
        ...
        return Tag.inserting(Component.text(species.baseStats[Stats.SPEED] ?: 0))
    }
}