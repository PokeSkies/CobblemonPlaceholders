...
class SpeciesCatchRate : CobblemonGlobalPlaceholder {
    override fun register(builder: Expansion.Builder) {
        builder.globalPlaceholder("species_catchrate", this)
    }
    ...
    override fun apply(queue: ArgumentQueue, ctx: Context): Tag {
        ...
        return Tag.inserting(Component.text(species.catchRate))
    }
}